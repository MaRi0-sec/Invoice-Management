...
<div class="login-wrapper">
    <div class="login-card">
        ...
        <p class="login-title">تعيين كلمة مرور جديدة</p>
        ...
        <form method="POST" action="{{ route('passwordUpdate') }}">
            ...
            <div class="form-group mb-4">
                ...
                <input type="password" name="password_confirmation" class="form-control" required placeholder="أعد كتابة كلمة المرور">
            </div>

            <button type="submit" class="btn btn-login">حفظ كلمة المرور الجديدة</button>
        </form>
    </div>
</div>
@endsection