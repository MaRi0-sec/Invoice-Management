                    ...
                    <form action="{{ route('invoice.update' , $invoices->id) }}" method="post" autocomplete="off">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select name="section_id" class="form-control SlectBox" onclick="console.log($(this).val())"
                                    ...
                                    <!--placeholder-->
                                    <option value="{{ $invoices->section->id }}" readonly>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="total_with_value_vat" name="total_with_value_vat" readonly
                                    value="{{ $invoices->total_with_value_vat }}">
                            </div>
